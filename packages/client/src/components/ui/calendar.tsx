...
import { Button, buttonVariants } from '@cf-tamac/client/components/ui/button';
...
interface CalendarClassNameOptions {
...
function buildCalendarClassNames({
  ...
  captionLayout,
  buttonVariant,
}: CalendarClassNameOptions): CalendarProps['classNames'] {
  return {
