...
export async function getThread(
  ...
  return {
    threadId: toSafeString(thread?.threadId, threadId),
    threadKey: toSafeString(thread?.threadKey),
    status: toSafeString(thread?.status),
...
function toBrowserSafeThreadSummary(thread: unknown): BrowserSafeThreadSummary {
...
function toBrowserSafeThreadSection(section: unknown): BrowserSafeThreadSectionSummary | undefined {
...
function toBrowserSafeEventSummary(event: unknown): BrowserSafeEventSummary {
...
function toBrowserSafeRunSummary(
  run: unknown,
  fallbackRunId = '',
  fallbackStatus = ''
...
function toBrowserSafeRunInput(input: unknown): BrowserSafeRunInputSnapshot | undefined {
...
function toBrowserSafeRunSnapshot(snapshot: unknown): BrowserSafeRunSnapshotReference | undefined {
...
function toBrowserSafeCompaction(
  compaction: unknown,
  snapshot: unknown
...
function toBrowserSafeThreadMemoryItem(item: unknown): BrowserSafeThreadMemoryItem {
...
function toBrowserSafeHistoryItem(result: unknown): BrowserSafeThreadHistoryItem {
