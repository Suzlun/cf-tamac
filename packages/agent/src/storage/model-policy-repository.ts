...
/**
 * Model policy status のうち、Run selection に使えるかを判定する安定値です。
 */
...
/**
 * Model policy repository が受け取る secret-free policy 入力です。
 */
...
/**
 * Model policy validation issue の永続化しない安全な表現です。
 */
...
/**
 * Agent-owned model policy table の行です。
 */
...
/**
 * Model policy upsert の repository 入力です。
 */
...
/**
 * Model policy archive の repository 入力です。
 */
...
/**
 * Model policy list の repository 入力です。
 */
...
/**
 * Agent-owned model policy repository です。
 */
...
/**
 * Policy status 文字列を repository の安定 status へ正規化します。
 */
