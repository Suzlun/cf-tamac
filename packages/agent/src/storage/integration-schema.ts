...
/**
 * Integration manifest から検証済み Definition summary を保存する table です。
 */
...
/**
 * Installation に付与された Integration grant を保存する table です。
 */
...
/**
 * Provider detached signature 検証用の Installation trust key table です。
 */
...
/**
 * Manifest 内の Adapter definition を保存する table です。
 */
...
/**
 * Adapter Connection lifecycle と Connection 単位の ingress grant を保存する table です。
 */
...
/**
 * Adapter ingress から派生した response capability を保存する table です。
 */
...
/**
 * Agent から Provider へ送った AdapterDelivery と結果 callback を追跡する table です。
 */
...
/**
 * Integration storage table 定義 metadata です。
 */
...
/**
 * Integration storage の Drizzle schema map です。
 */
...
/**
 * Integration storage table 名の一覧です。
 */
...
/**
 * Integration storage repository 名の一覧です。
 */
