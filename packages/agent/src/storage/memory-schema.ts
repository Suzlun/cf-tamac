...
/**
 * Drizzle schema map for Stage 4 memory, compaction, archive, and R2 index tables.
 */
...
/**
 * Stage 4 Agent-owned SQLite table names.
 */
...
/**
 * Stage 4 Agent storage table definition metadata.
 */
...
/**
 * Stage 4 storage repository names.
 */
