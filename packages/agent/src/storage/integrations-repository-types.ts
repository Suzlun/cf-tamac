/**
 * Integration Installation の永続行です。
 */
...
/**
 * Integration definition summary の永続行です。
 */
...
/**
 * Integration grant ledger の永続行です。
 */
...
/**
 * Integration repository が提供する Agent-scoped 永続化操作です。
 */
...
/** Adapter definition upsert 入力です。 */
...
/** Installation 所有行を一括 disable/revoke する入力です。 */
...
/** Installation 所有 grant/trust を revoke する入力です。 */
