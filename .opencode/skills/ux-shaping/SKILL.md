...
2. Shared Management Client UI, tokens, and contracts under
   `packages/client/src/components/**`
3. `packages/client/components.json`, `packages/client/app/globals.css`, and
   existing component states and compositions
...
- Never invent a component system before inspecting the Management Client's
