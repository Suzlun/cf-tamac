...
- [ ] 2.9 `@typespec/protobuf`、package `aia.agent.v1`、明示 field number、reserved-field policy、unary RPC shape、binary Connect production profile notes を設定/確認する。
...
- [ ] 2.11 `packages/agent/proto/aia/agent/v1`、`packages/agent/src/generated/rpc`、`packages/client/src/generated/agent-rpc` を生成 scripts だけで更新する。完了条件は `proto/**` と `generated/**` に手編集がないこと。
