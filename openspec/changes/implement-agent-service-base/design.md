...
| Update     | `packages/agent/src/typespec/main.tsp`                            | `aia.agent.v1` の TypeSpec Protobuf entrypoint を全 Stage 1〜8 services/models へ接続する。                                                                                                                 |
...
| Generated  | `packages/agent/proto/aia/agent/v1/*.proto`                       | TypeSpec から生成する proto3 artifact。手編集しない。                                                                                                                                                       |
| Generated  | `packages/agent/src/generated/rpc/aia/agent/v1/*_pb.ts`           | Protobuf-ES generated server/client descriptor。手編集しない。                                                                                                                                              |
...
| Generated  | `packages/client/src/generated/agent-rpc/aia/agent/v1/*_pb.ts`    | Agent RPC client descriptor。手編集しない。                                                                                                                                                                 |
...
- Contract rollback: `aia.agent.v1` では field number を再利用せず、破壊的変更は `v2` package 追加で扱う。rollback は直近の TypeSpec/proto/generated artifact を再生成して差分確認する。
