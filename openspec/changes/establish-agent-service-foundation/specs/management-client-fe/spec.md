...
#### Scenario: Agent registry shell renders for a browser user (MANAGEMENT-CLIENT-FE-S001)
...
#### Scenario: Browser bundles do not call Agent RPC directly (MANAGEMENT-CLIENT-FE-S002)
...
#### Scenario: Client exposes no Agent API proxy routes (MANAGEMENT-CLIENT-FE-S008)
...
#### Scenario: Client D1 exposes only management tables (MANAGEMENT-CLIENT-FE-S003)
...
#### Scenario: Client repository rejects Agent-domain snapshot persistence (MANAGEMENT-CLIENT-FE-S004)
...
#### Scenario: Client Worker binding set is isolated from Agent runtime (MANAGEMENT-CLIENT-FE-S005)
...
#### Scenario: Client imports generated Agent RPC code without Agent runtime source (MANAGEMENT-CLIENT-FE-S006)
...
#### Scenario: Management routes contain no demo navigation (MANAGEMENT-CLIENT-FE-S007)
